...
We now initialize a "vertex array" on the GPU to store the vertices
	and faces of a mesh. To render, we simply triggers the GPU to draw the stored mesh data.
...
ShaderProgram defaultShader() {
	...
	try {
		shader.load("shaders/no_transform.vert", "shaders/all_green.frag");
		shader.activate();
	}
